...
then it fires; no fiddly pinch), **making a fist** grabs and drags the page to scroll,
and in the modern era your hands push and ripple the liquid chrome in real time.
Strictly opt-in, torn down when off, all inference local — nothing leaves the browser.
